//
//  YFOtherInputCollectionViewCell.m
//  YFKit
//
//  Created by 王宇 on 2018/5/17.
//  Copyright © 2018年 wy. All rights reserved.
//

#import "YFOtherInputCollectionViewCell.h"

@implementation YFOtherInputCollectionViewCell
...
- (void)awakeFromNib {
    ...
    [[self.textField rac_textSignal] subscribeNext:^(id x) {
        ...
        if (string.length > 30) {
            self.textField.text = [string substringWithRange:NSMakeRange(0, 30)];
        }
        DLog(@"%@",string);
    }];
}
